        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          <div className="space-y-8">
            <header className="mb-8">
              <div className="bg-white rounded p-2 inline-block relative">
                ...
                />
                <span className="absolute top-1 right-1 text-xs text-gray-700 font-bold select-none">®</span>
              </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><a href="/legal" className="text-white-400 hover:text-white">Legal</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4 mt-4">
              ...
              <a href="https://linkedin.com/in/transitley" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
                <svg className="w-6 h-6 text-white-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
