...
export default function VisaWithSolicitor() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900">
      {/* Header */}
      <header className="bg-gradient-to-br from-slate-800 via-teal-800 to-emerald-900 text-white">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="w-full md:w-1/2">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold leading-tight mb-3">
                Your Fast-Track to the UK — Study, Work, Innovate & Settle
              </h1>
              
              <p className="text-lg md:text-xl opacity-90 mb-4">
                Backed by our <strong>in-house immigration solicitor</strong>, Transitley guides you through Global Talent, Innovator Founder, Student admissions and ILR applications — end-to-end.
              </p>

              <div className="flex flex-wrap gap-3 mb-4">
                <a 
                  className="inline-flex items-center justify-center rounded-lg bg-white text-teal-800 font-semibold px-5 py-3 shadow hover:shadow-lg transition-all" 
                  href="https://docs.google.com/forms/d/1-fOcqfMKJXuq7wHnUhZ3xjYxY3_jPFSuE6-ml9o3hSc"
                >
                  Book Free Consultation
                </a>
                <a 
                  className="inline-flex items-center justify-center rounded-lg border border-white/30 text-white px-4 py-3 hover:bg-white/10 transition-all" 
                  href="#services"
                >
                  See Services
                </a>
              ...
              <div className="flex items-center gap-4">
                <div className="flex-shrink-0 bg-white/10 px-3 py-2 rounded-lg">
                  <svg className="w-8 h-8" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 2v7M6 9v13h12V9" stroke="#fff" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <div>
      ...
      <main className="max-w-6xl mx-auto px-6 py-10">
        ...
        {/* Services Section */}
        <section id="services" className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          
          <article className="bg-white rounded-xl p-6 shadow">
            <h3 className="font-semibold text-lg text-teal-900">Global Talent Visa (GTV)</h3>
            <p className="mt-2 text-sm opacity-80">
              For leaders & emerging leaders in tech, research, arts & business. We handle endorsements, evidence packages and applications — helping you reach ILR faster.
            </p>
          ...
          <article className="bg-white rounded-xl p-6 shadow">
            <h3 className="font-semibold text-lg text-teal-900">Innovator Founder Visa</h3>
            <p className="mt-2 text-sm opacity-80">
              Support for founders with scalable, innovative business ideas. Business plan creation, endorsement routes, viability & UK set-up guidance.
            </p>
            <ul className="mt-3 text-sm space-y-2">
          ...
          <article className="bg-white rounded-xl p-6 shadow">
            <h3 className="font-semibold text-lg text-teal-900">Student Admissions & Visas</h3>
            <p className="mt-2 text-sm opacity-80">
              University placement, CAS management, visa application and post-arrival support — designed for international students and their families.
            </p>
            <ul className="mt-3 text-sm space-y-2">
        ...
        {/* Settlement & ILR */}
        <section className="bg-gradient-to-r from-teal-50 to-white rounded-xl p-6 border mb-8">
          <div className="md:flex md:items-center md:justify-between">
            <div>
              <h3 className="text-xl font-semibold text-teal-900">Settlement (ILR & SET(P))</h3>
            ...
            <div className="mt-4 md:mt-0">
              <a className="inline-flex items-center rounded-lg bg-teal-800 text-white px-4 py-3 font-semibold shadow hover:bg-teal-900 transition-all" href="https://docs.google.com/forms/d/1-fOcqfMKJXuq7wHnUhZ3xjYxY3_jPFSuE6-ml9o3hSc">Speak to a Solicitor</a>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="col-span-2 bg-white rounded-xl p-6 shadow">
            <h3 className="text-lg font-semibold text-teal-900">Why Transitley?</h3>
          ...
          <aside className="bg-white rounded-xl p-6 shadow">
            <h4 className="font-semibold text-teal-900">Success Snapshot</h4>
            <p className="mt-2 text-sm opacity-80">30+ countries served · 200+ applications assisted · 95% satisfaction</p>

            <div className="mt-4">
              <div className="text-xs uppercase font-medium text-teal-800">Trusted</div>
        ...
        {/* CTA strip */}
        <section id="book" className="rounded-xl p-8 bg-gradient-to-r from-slate-800 via-teal-800 to-emerald-900 text-white flex flex-col md:flex-row items-center justify-between">
          <div>
          ...
          <div className="mt-4 md:mt-0">
            <a className="inline-flex items-center rounded-lg bg-white text-teal-800 px-5 py-3 font-semibold shadow hover:shadow-lg transition-all" href="https://docs.google.com/forms/d/1-fOcqfMKJXuq7wHnUhZ3xjYxY3_jPFSuE6-ml9o3hSc">Book Free Consultation</a>
          </div>
        </section>
