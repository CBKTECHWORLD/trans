...
const LanguageCourses: React.FC = () => {
  ...
  const courses: Course[] = [
    ...
    // Other English Tests
    {
      ...
      category: 'test',
      description: 'Focused preparation for Duolingo English Test',
    ...
    // German Language
    {
      ...
      name: 'German',
      category: 'language',
      description: 'German language courses covering Basic to B1 levels including A1, A2, and B1 ',
  ...
  return (
    ...
    text-gray-900
    placeholder-gray-500 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-600 focus:border-transparent outline-none"
              />
            </div>
          </div>
      ...
      <section className="bg-gray-900 text-white py-6">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-300 mb-4">Take the first step towards achieving your goals today.</p>
          <a
            href="http://academy.transitley.com/"
            target="_blank"
            rel="noopener noreferrer"
